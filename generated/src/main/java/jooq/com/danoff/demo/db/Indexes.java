...
public class Indexes {
    ...
    private static class Indexes0 {
        public static Index CONSTRAINT_INDEX_7 = Internal.createIndex("CONSTRAINT_INDEX_7", Employee.EMPLOYEE, new OrderField[] { Employee.EMPLOYEE.EMAIL }, true);
        public static Index PRIMARY_KEY_7 = Internal.createIndex("PRIMARY_KEY_7", Employee.EMPLOYEE, new OrderField[] { Employee.EMPLOYEE.ID }, true);
